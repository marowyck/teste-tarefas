...
export default function Stats() {
  const [statsArray, setStatsArray] = useState<SingleStat[]>([
    { label: "Completas", unit: "Tarefas", counter: 3 },
    { label: "Faltando", unit: "Tarefas", counter: 4 },
    { label: "Progresso", unit: "%", counter: 4 },
  ]);
  ...
  useEffect(() => {
    ...
    setStatsArray([
      { label: "Completas", unit: "Tarefas", counter: getCompletedTasks },
      { label: "Faltando", unit: "Tarefas", counter: getPendingTasks },
      {
        label: "Progresso",
        unit: "%",
